    ...
    function form($instance) {
        ...
        ?>
            <p>
                ...
                <input class="widefat" id="<?php echo $this->get_field_id('whimsy_social_twitter'); ?>" name="<?php echo $this->get_field_name('whimsy_social_twitter'); ?>" type="text" value="<?php echo esc_attr($whimsy_social_twitter); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('whimsy_social_pinterest'); ?>">Pinterest: </label>
                <input class="widefat" id="<?php echo $this->get_field_id('whimsy_social_pinterest'); ?>" name="<?php echo $this->get_field_name('whimsy_social_pinterest'); ?>" type="text" value="<?php echo esc_attr($whimsy_social_pinterest); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('whimsy_social_facebook'); ?>">Facebook: </label>
                <input class="widefat" id="<?php echo $this->get_field_id('whimsy_social_facebook'); ?>" name="<?php echo $this->get_field_name('whimsy_social_facebook'); ?>" type="text" value="<?php echo esc_attr($whimsy_social_facebook); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('whimsy_social_google_plus'); ?>">Google+: </label>
                <input class="widefat" id="<?php echo $this->get_field_id('whimsy_social_google_plus'); ?>" name="<?php echo $this->get_field_name('whimsy_social_google_plus'); ?>" type="text" value="<?php echo esc_attr($whimsy_social_google_plus); ?>" />
            </p>
            <p>
                <label for="<?php echo $this->get_field_id('whimsy_social_linkedin'); ?>">LinkedIn: </label>
                <input class="widefat" id="<?php echo $this->get_field_id('whimsy_social_linkedin'); ?>" name="<?php echo $this->get_field_name('whimsy_social_linkedin'); ?>" type="text" value="<?php echo esc_attr($whimsy_social_linkedin); ?>" />
            </p>
