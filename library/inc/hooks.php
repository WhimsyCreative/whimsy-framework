...
// header.php
function whimsy_body_start() {
 whimsy_do_atomic( 'whimsy_body_start' ); }
function whimsy_header() {
 whimsy_do_atomic( 'whimsy_header' ); }
function whimsy_header_before() {
 whimsy_do_atomic( 'whimsy_header_before' ); }
function whimsy_header_after() {
 whimsy_do_atomic( 'whimsy_header_after' ); }
function whimsy_header_inside_before() {
 whimsy_do_atomic( 'whimsy_header_inside_before' ); }
function whimsy_header_inside_after() {
 whimsy_do_atomic( 'whimsy_header_inside_after' ); }
function whimsy_nav_before() {
 whimsy_do_atomic( 'whimsy_nav_before' ); }
function whimsy_nav_after() {
 whimsy_do_atomic( 'whimsy_nav_after' ); }
function whimsy_nav_inside_before() {
 whimsy_do_atomic( 'whimsy_nav_inside_before' ); }
function whimsy_nav_inside_after() {
 whimsy_do_atomic( 'whimsy_nav_inside_after' ); }

// Content
function whimsy_content_before() {
 whimsy_do_atomic( 'whimsy_content_before' ); }
function whimsy_content_after() {
 whimsy_do_atomic( 'whimsy_content_after' ); }
function whimsy_main_before() {
 whimsy_do_atomic( 'whimsy_main_before' ); }
function whimsy_main_after() {
 whimsy_do_atomic( 'whimsy_main_after' ); }
function whimsy_main_inside_before() {
 whimsy_do_atomic( 'whimsy_main_inside_before' ); }
function whimsy_main_inside_after() {
 whimsy_do_atomic( 'whimsy_main_inside_after' ); }
function whimsy_page_before() {
 whimsy_do_atomic( 'whimsy_page_before' ); }
function whimsy_page_after() {
 whimsy_do_atomic( 'whimsy_page_after' ); }
function whimsy_post_before() {
 whimsy_do_atomic( 'whimsy_post_before' ); }
function whimsy_post_after() {
 whimsy_do_atomic( 'whimsy_post_after' ); }
function whimsy_post_meta_before() {
 whimsy_do_atomic( 'whimsy_post_meta_before' ); }
function whimsy_post_meta_after() {
 whimsy_do_atomic( 'whimsy_post_meta_after' ); }
function whimsy_post_meta_inside() {
 whimsy_do_atomic( 'whimsy_post_meta_inside' ); }
function whimsy_post_footer_before() {
 whimsy_do_atomic( 'whimsy_post_footer_before' ); }
function whimsy_post_footer_after() {
 whimsy_do_atomic( 'whimsy_post_footer_after' ); }

// Sidebar
function whimsy_sidebar_before() {
 whimsy_do_atomic( 'whimsy_sidebar_before' ); }
function whimsy_sidebar_inside_before() {
 whimsy_do_atomic( 'whimsy_sidebar_inside_before' ); }
function whimsy_sidebar_inside_after() {
 whimsy_do_atomic( 'whimsy_sidebar_inside_after' ); }
function whimsy_sidebar_after() {
 whimsy_do_atomic( 'whimsy_sidebar_after' ); }
function whimsy_sidebar_inside_widget_before() {
 whimsy_do_atomic( 'whimsy_sidebar_inside_widget_before' ); }
function whimsy_sidebar_inside_widget_after() {
 whimsy_do_atomic( 'whimsy_sidebar_inside_widget_after' ); }

// footer.php
function whimsy_footer_before() {
 whimsy_do_atomic( 'whimsy_footer_before' ); }
function whimsy_footer_after() {
 whimsy_do_atomic( 'whimsy_footer_after' ); }
function whimsy_footer_inside_before() {
 whimsy_do_atomic( 'whimsy_footer_inside_before' ); }
function whimsy_footer_inside_after() {
 whimsy_do_atomic( 'whimsy_footer_inside_after' ); }
function whimsy_footer() {
 whimsy_do_atomic( 'whimsy_footer' ); }
function whimsy_body_end() {
 whimsy_do_atomic( 'whimsy_body_end' ); }
