...
function whimsy_header_inside() 		{ whimsy_do_atomic( 'whimsy_header_inside' ); }
...
function whimsy_nav_inside() 			{ whimsy_do_atomic( 'whimsy_nav_inside' ); }
...
function whimsy_post_meta_before() 		{ whimsy_do_atomic( 'before_post_meta' ); }
function whimsy_post_meta_after() 		{ whimsy_do_atomic( 'after_post_meta' ); }
...
function whimsy_footer_inside() 		{ whimsy_do_atomic( 'whimsy_footer_inside' ); }
